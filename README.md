...
<div class="container">
    ...
    <div class="section-box">
        ...
        <!-- 第一行：JoongDunk, Joong, Dunk -->
        <div class="free-text-buttons row-1">
        ...
        <!-- 第二行：JadeKamin, Jade, Kamin -->
        <div class="free-text-buttons row-2">
        ...
        <!-- 第三行：Dare You To Death, จุงดัง -->
        <div class="free-text-buttons row-3">
 ...
 "{Input} is calm that cuts"
        ...
        th: {
            hype: [
                ...
                "ทำไม {Input} ถึงได้สมบูรณ์แบบขนาดนี้!!!",
